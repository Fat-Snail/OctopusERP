...
<template>
  <header class="h-12 shrink-0 bg-card border-b border-border flex items-center px-4 gap-3">
    ...
    <div class="flex items-center gap-1.5 h-7 px-2.5 bg-muted rounded-[var(--radius)] w-[240px] text-[12px] text-muted-foreground cursor-text">
      ...
      <kbd class="font-mono text-[10px] px-1 py-0 rounded border border-border-strong bg-subtle text-muted-foreground">⌘K</kbd>
    </div>
    ...
    >
      ...
      <span
        ...
        class="absolute top-1 right-1 bg-danger text-white text-[9px] font-semibold px-1 py-0 rounded-full min-w-[14px] text-center leading-[1.4]"
      >
