...
const groups: NavGroup[] = [
  {
    group: '工作',
    items: [
      { label: '生产看板', path: '/home' },
    ],
  },
  {
    group: '采购',
    items: [
      { label: '供应商管理', path: '/supplier' },
      { label: '采购订单', path: '/purchase' },
    ],
  },
  {
    group: '生产',
    items: [
      { label: '工单管理', path: '/workorder' },
    ],
  },
]
...
<template>
  <nav class="w-[200px] shrink-0 bg-card border-r border-border flex flex-col">
    ...
    <div class="px-3.5 pt-3.5 pb-2.5 border-b border-border shrink-0">
      <div class="text-[13px] font-semibold text-foreground">MES 生产采购</div>
      <div class="text-[10.5px] text-muted-foreground font-mono tracking-[0.04em] mt-0.5">MES</div>
    </div>
